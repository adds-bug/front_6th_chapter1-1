...
`,a=Array.from({length:4},()=>i).join(``),o=e=>`
    ...
    `,s=({products:e=[],loading:t=!1,total:n=0,categories:r})=>{let i=Object.keys(r);return`
          ...
          <div class="space-y-3">
            ...
            <div class="space-y-2">
              ...
              <div class="flex flex-wrap gap-2">
                ${t?`<div class="text-sm text-gray-500 italic">카테고리 로딩 중...</div>`:`출력`}
